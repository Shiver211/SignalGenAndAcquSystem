...
# AD9767 双通道 14 位并行接口全部在 Bank15；上板前实测 VCCIO 为 3.3V。
set_property PACKAGE_PIN K18 [get_ports {dac_db[0]}]
set_property PACKAGE_PIN K19 [get_ports {dac_db[1]}]
set_property PACKAGE_PIN G16 [get_ports {dac_db[2]}]
set_property PACKAGE_PIN G15 [get_ports {dac_db[3]}]
set_property PACKAGE_PIN G13 [get_ports {dac_db[4]}]
set_property PACKAGE_PIN H13 [get_ports {dac_db[5]}]
set_property PACKAGE_PIN H17 [get_ports {dac_db[6]}]
set_property PACKAGE_PIN H18 [get_ports {dac_db[7]}]
set_property PACKAGE_PIN H14 [get_ports {dac_db[8]}]
set_property PACKAGE_PIN J14 [get_ports {dac_db[9]}]
set_property PACKAGE_PIN J19 [get_ports {dac_db[10]}]
set_property PACKAGE_PIN H19 [get_ports {dac_db[11]}]
set_property PACKAGE_PIN K13 [get_ports {dac_db[12]}]
set_property PACKAGE_PIN K14 [get_ports {dac_db[13]}]
set_property PACKAGE_PIN L13 [get_ports dac_wr2]
set_property PACKAGE_PIN M13 [get_ports dac_bclk]
set_property PACKAGE_PIN M15 [get_ports dac_aclk]
set_property PACKAGE_PIN M16 [get_ports dac_wr1]
set_property PACKAGE_PIN K21 [get_ports {dac_da[0]}]
set_property PACKAGE_PIN K22 [get_ports {dac_da[1]}]
set_property PACKAGE_PIN J20 [get_ports {dac_da[2]}]
set_property PACKAGE_PIN J21 [get_ports {dac_da[3]}]
set_property PACKAGE_PIN J22 [get_ports {dac_da[4]}]
set_property PACKAGE_PIN H22 [get_ports {dac_da[5]}]
set_property PACKAGE_PIN L19 [get_ports {dac_da[6]}]
set_property PACKAGE_PIN L20 [get_ports {dac_da[7]}]
set_property PACKAGE_PIN N20 [get_ports {dac_da[8]}]
set_property PACKAGE_PIN M20 [get_ports {dac_da[9]}]
set_property PACKAGE_PIN N22 [get_ports {dac_da[10]}]
set_property PACKAGE_PIN M22 [get_ports {dac_da[11]}]
set_property PACKAGE_PIN M21 [get_ports {dac_da[12]}]
set_property PACKAGE_PIN L21 [get_ports {dac_da[13]}]
set_property IOSTANDARD LVCMOS33 [get_ports {dac_da[*] dac_db[*] dac_wr1 dac_wr2 dac_aclk dac_bclk}]
set_property DRIVE 8 [get_ports {dac_da[*] dac_db[*] dac_wr1 dac_wr2 dac_aclk dac_bclk}]
set_property SLEW FAST [get_ports {dac_da[*] dac_db[*] dac_wr1 dac_wr2 dac_aclk dac_bclk}]
