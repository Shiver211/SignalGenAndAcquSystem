...
module ddr3_subsystem_m6 (
    ...
    capture_storage_core_m5 #(
        ...
        .read_request_sample_count(raw_net_read_request_sample_count),
        .read_sample_data(raw_net_read_sample_data),
        .read_sample_valid(raw_net_read_sample_valid),
        .read_sample_ready(raw_net_read_sample_ready),
        .read_done_pulse(raw_net_read_done_pulse), .read_error(raw_net_read_error),
        .read_busy(),
        .app_addr(app_addr), .app_cmd(app_cmd), .app_en(app_en),
        .app_rdy(app_rdy), .app_wdf_data(app_wdf_data),
        ...
        .frame_wrapped(frame_wrapped), .frame_done_ui(),
